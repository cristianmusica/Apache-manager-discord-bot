...
async def help(ctx):
    ...
    embed.add_field(name="!modify_index", value="Modifies the specified file in the current directory.", inline=False)
    embed.add_field(name="!create_file", value="Creates a new file in the specified location.", inline=False)
    embed.add_field(name="!help", value="Displays this help message.", inline=False)
    embed.add_field(name="Modificar", value="Press this button to modify a file.", inline=False)
    embed.add_field(name="Crear", value="Press this button to create a file.", inline=False)
